...
deleteUser (user){ //(27) aggiungo un metodo deleteUser che riceve il valore user
  ...
  this.userService.deleteUser(this.user); //(32) chiamo il metodo deleteUser (dalla classe userService per cancellare this.user) (33) faccio richiamare il metodo direttamente dal componente padre (users)
              }
                                            }
